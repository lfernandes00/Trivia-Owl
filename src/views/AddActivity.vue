<template>
  <div id="AddActivity">
    <b-container fluid>
      <b-row>
        <b-col cols="6">
          <b-form @submit.prevent="createActivity" class="mt-4 ml-4">
            ...
            >
              <b-form-input
                class="mt-1 mb-1"
                id="input-9"
                v-model="activity.question1.enunciated"
                type="text"
              ></b-form-input>
              <b-form-input
                class="mt-1 mb-1"
                id="input-10"
                v-model="activity.question1.firstAnswer"
                type="text"
              ></b-form-input>
              <b-form-input
                class="mt-1 mb-1"
                id="input-11"
                v-model="activity.question1.secondAnswer"
                type="text"
              ></b-form-input>
              <b-form-input
                class="mt-1 mb-1"
                id="input-12"
                v-model="activity.question1.thirdAnswer"
                type="text"
              ></b-form-input>
              <b-form-input
                class="mt-1 mb-1"
                id="input-13"
                v-model="activity.question1.fourthAnswer"
                type="text"
              ></b-form-input>
              <b-form-select
                class="mt-1 mb-1"
            ...
            >
              <b-form-input
                class="mt-1 mb-1"
                id="input-15"
                v-model="activity.question2.enunciated"
                type="text"
              ></b-form-input>
              <b-form-input
                class="mt-1 mb-1"
                id="input-16"
                v-model="activity.question2.firstAnswer"
                type="text"
              ></b-form-input>
              <b-form-input
                class="mt-1 mb-1"
                id="input-17"
                v-model="activity.question2.secondAnswer"
                type="text"
              ></b-form-input>
              <b-form-input
                class="mt-1 mb-1"
                id="input-18"
                v-model="activity.question2.thirdAnswer"
                type="text"
              ></b-form-input>
              <b-form-input
                class="mt-1 mb-1"
                id="input-19"
                v-model="activity.question2.fourthAnswer"
                type="text"
              ></b-form-input>
              <b-form-select
                class="mt-1 mb-1"
            ...
            >
              <b-form-input
                class="mt-1 mb-1"
                id="input-21"
                v-model="activity.question3.enunciated"
                type="text"
              ></b-form-input>
              <b-form-input
                class="mt-1 mb-1"
                id="input-22"
                v-model="activity.question3.firstAnswer"
                type="text"
              ></b-form-input>
              <b-form-input
                class="mt-1 mb-1"
                id="input-23"
                v-model="activity.question3.secondAnswer"
                type="text"
              ></b-form-input>
              <b-form-input
                class="mt-1 mb-1"
                id="input-24"
                v-model="activity.question3.thirdAnswer"
                type="text"
              ></b-form-input>
              <b-form-input
                class="mt-1 mb-1"
                id="input-25"
                v-model="activity.question3.fourthAnswer"
                type="text"
              ></b-form-input>
              <b-form-select
                class="mt-1 mb-1"
            ...
            >
              <b-form-input
                class="mt-1 mb-1"
                id="input-27"
                v-model="activity.question4.enunciated"
                type="text"
              ></b-form-input>
              <b-form-input
                class="mt-1 mb-1"
                id="input-28"
                v-model="activity.question4.firstAnswer"
                type="text"
              ></b-form-input>
              <b-form-input
                class="mt-1 mb-1"
                id="input-29"
                v-model="activity.question4.secondAnswer"
                type="text"
              ></b-form-input>
              <b-form-input
                class="mt-1 mb-1"
                id="input-30"
                v-model="activity.question4.thirdAnswer"
                type="text"
              ></b-form-input>
              <b-form-input
                class="mt-1 mb-1"
                id="input-31"
                v-model="activity.question4.fourthAnswer"
                type="text"
              ></b-form-input>
              <b-form-select
                class="mt-1 mb-1"
            ...
            >
              <b-form-input
                class="mt-1 mb-1"
                id="input-33"
                v-model="activity.question5.enunciated"
                type="text"
              ></b-form-input>
              <b-form-input
                class="mt-1 mb-1"
                id="input-34"
                v-model="activity.question5.firstAnswer"
                type="text"
              ></b-form-input>
              <b-form-input
                class="mt-1 mb-1"
                id="input-35"
                v-model="activity.question5.secondAnswer"
                type="text"
              ></b-form-input>
              <b-form-input
                class="mt-1 mb-1"
                id="input-36"
                v-model="activity.question5.thirdAnswer"
                type="text"
              ></b-form-input>
              <b-form-input
                class="mt-1 mb-1"
                id="input-37"
                v-model="activity.question5.fourthAnswer"
                type="text"
              ></b-form-input>
              <b-form-select
                class="mt-1 mb-1"
...
class Activity {
  constructor(name, course, subject, points, type, desc, photo, question1, question2, question3, question4, question5, pending) {
    this.name = name;
    this.course = course;
...
export default {
  ...
  methods: {
      ...
      try {
        ...
        await this.$store.dispatch("createActivity", newActivity);
