      ...
      <b-row class="mt-5">
        ...
        <b-col>
          <div style="text-align: start" class="mt-3">
            <h1 style="color: #FF7070">{{$route.params.activityName}}</h1><br>
        ...
        <div class="ml-5">
          ...
          <b-form id="activityForm" @submit.prevent="submit">
            <b-form-group id="firstQuestion">
              ...
              <b-form-radio size="lg" value="Q1A1" v-model="answers.A1">{{questions.question1.firstOption}}</b-form-radio><br>
              <b-form-radio size="lg" value="Q1A2" v-model="answers.A1">{{questions.question1.secondOption}}</b-form-radio><br>
              <b-form-radio size="lg" value="Q1A3" v-model="answers.A1">{{questions.question1.thirdOption}}</b-form-radio><br>
              <b-form-radio size="lg" value="Q1A4" v-model="answers.A1">{{questions.question1.fourthOption}}</b-form-radio>
            </b-form-group>

            <b-form-group id="secondQuestion">
              <h2 style="color: #FF7070">Pergunta 2</h2><br>
              <label id="enunciatedQ2" for="question2">{{questions.question2.enunciated}}</label><br><br>
              <b-form-radio size="lg" value="Q2A1" v-model="answers.A2">{{questions.question2.firstOption}}</b-form-radio><br>
              <b-form-radio size="lg" value="Q2A2" v-model="answers.A2">{{questions.question2.secondOption}}</b-form-radio><br>
              <b-form-radio size="lg" value="Q2A3" v-model="answers.A2">{{questions.question2.thirdOption}}</b-form-radio><br>
              <b-form-radio size="lg" value="Q2A4" v-model="answers.A2">{{questions.question2.fourthOption}}</b-form-radio>
            </b-form-group>
            
            <b-form-group id="thirdQuestion">
              <h2 style="color: #FF7070">Pergunta 3</h2><br>
              <label id="enunciatedQ3" for="question3">{{questions.question3.enunciated}}</label><br><br>
              <b-form-radio size="lg" value="Q3A1" v-model="answers.A3">{{questions.question3.firstOption}}</b-form-radio><br>
              <b-form-radio size="lg" value="Q3A2" v-model="answers.A3">{{questions.question3.secondOption}}</b-form-radio><br>
              <b-form-radio size="lg" value="Q3A3" v-model="answers.A3">{{questions.question3.thirdOption}}</b-form-radio><br>
              <b-form-radio size="lg" value="Q3A4" v-model="answers.A3">{{questions.question3.fourthOption}}</b-form-radio>
            </b-form-group>

            <b-form-group id="fourthQuestion">
              <h2 style="color: #FF7070">Pergunta 4</h2><br>
              <label id="enunciatedQ4" for="question4">{{questions.question4.enunciated}}</label><br><br>
              <b-form-radio size="lg" value="Q4A1" v-model="answers.A4">{{questions.question4.firstOption}}</b-form-radio><br>
              <b-form-radio size="lg" value="Q4A2" v-model="answers.A4">{{questions.question4.secondOption}}</b-form-radio><br>
              <b-form-radio size="lg" value="Q4A3" v-model="answers.A4">{{questions.question4.thirdOption}}</b-form-radio><br>
              <b-form-radio size="lg" value="Q4A4" v-model="answers.A4">{{questions.question4.fourthOption}}</b-form-radio>
            </b-form-group>

            <b-form-group id="fifthQuestion">
              <h2 style="color: #FF7070">Pergunta 5</h2><br>
              <label id="enunciatedQ5" for="question5">{{questions.question5.enunciated}}</label><br><br>
              <b-form-radio size="lg" value="Q5A1" v-model="answers.A5">{{questions.question5.firstOption}}</b-form-radio><br>
              <b-form-radio size="lg" value="Q5A2" v-model="answers.A5">{{questions.question5.secondOption}}</b-form-radio><br>
              <b-form-radio size="lg" value="Q5A3" v-model="answers.A5">{{questions.question5.thirdOption}}</b-form-radio><br>
              <b-form-radio size="lg" value="Q5A4" v-model="answers.A5">{{questions.question5.fourthOption}}</b-form-radio>
            </b-form-group>
...
export default {
  ...
  methods: {
    submit() {
      ...
      if (this.answers.A2 === this.questions.question2.correctOption) {
        score += 2;
      }
      if (this.answers.A3 === this.questions.question3.correctOption) {
        score += 2;
      }
      if (this.answers.A4 === this.questions.question4.correctOption) {
        score += 2;
      }
